      ...
      <div className="m-auto w-4/5 py-36 md:w-3/5">
        ...
        <div className="my-14 place-content-around md:flex">
          ...
          <div className="md:w-full">
            <p>
              Nunc pulvinar orci a diam aliquam, nec varius quam tristique.
              Pellentesque nec porttitor risus. Nullam ac arcu sed purus
              fermentum dignissim. Maecenas ut nibh dui. Nulla suscipit vitae
              sem at laoreet. Aliquam dignissim varius sem, at finibus tellus
              feugiat ut. Quisque massa tortor, dignissim quis pharetra at,
              egestas id ipsum. Nunc varius gravida risus at lobortis. Sed a ex
              nisl.
            </p>
          </div>
        </div>
