...
const hero = {
  ...
  title: 'Web Developer',
  description: 'I create and maintain modern websites that help your business grow.',
    ...
    <section className="flex md:h-screen">
      <div className="m-auto my-20 w-4/5 justify-center gap-20 text-center text-neutral-800 md:flex md:items-center md:text-left">
        <div className="inline-block">
          <Image className="rounded-tr-[80px] rounded-bl-[80px]" src={hero.image} alt="" width={320} height={320} />
        </div>
